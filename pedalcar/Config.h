...
#define COMMUNICATION_PORT Serial1  // Choisissez entre Serial, Serial1, Serial2, etc.
...
#define DEFAULT_MODE "BLE"   // Modes possibles : "SERIAL", "BLE"
...
#define SERVO_ROUE_ROTATION_MAX 60 // Jusqu'où on laisse tourner les roues (Symétrique des deux côtés)
